  ...
  return (
    <div style={{ height: "100%" }}>
      ...
      <Dialog open={showMobileDialog}>
        ...
        <DialogContent>
          Disbox is not supported for the poor people.Get a pc loser
        </DialogContent>
        <DialogActions>
      ...
      <div className="App App-header">
        <div style={{ width: "100%", backgroundColor: "#2F3136" }}>
          ...
          <div className='m-5'>
            ...
            <Button className="m-2" style={{ fontSize: "2.5rem" }} variant="secondary" onClick={() => { window.open("https://github.com/DisboxApp/web") }}><b>Fuck around and find out</b></Button>
          </div>
        </div>
